...
あわせてタイムアウトの不在（クライアント・Gatewayとも0件）、無音でキャンセルを飲み込む経路、
公開版で何も残らない診断、長時間稼働の受け入れ試験の不在を解消する。**「再起動してください」を
回避策として案内する状態を公開品質と認めない。** 原因分析、マイルストーン、技術的負債の棚卸しは
